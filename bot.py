...
mergeApp = MergeBot(
    ...
    app_version="6.0+spidy-mergebot",
)
    ...
    if user.merge_mode == 4:
        ...
        if rmess.video or rmess.document:
            ...
            if file_name is None:
                await m.reply("Ohh Fuck !! File name not found; Any Query @Mr_SPIDY")
                return
...
🔰 ᴏᴡɴᴇʀ ᴄᴀɴ ʙʀᴏᴀᴅᴄᴀsᴛ ᴍᴇssᴀɢᴇ ᴛᴏ ᴀʟʟ ᴜsᴇʀs
        ...
        reply_markup=InlineKeyboardMarkup(
            [
                [InlineKeyboardButton("👨‍💻Developer👨‍💻", url="https://t.me/Mr_SPIDY")],
                [
                    InlineKeyboardButton(
                        "🏘Contact🏘", url="https://t.me/Mr_SpidyBot"
                    ),
                    InlineKeyboardButton(
                        "🤔Powered By🤔", url=f"https://t.me/YourDemandZone"
                    ),
                ],
                [InlineKeyboardButton("Close 🔐", callback_data="close")],
            ]
